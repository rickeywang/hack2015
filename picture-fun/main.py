...
class get_img_handler(webapp2.RedirectHandler):
    ...
    def get(self):
        ...
        img_metadata = {
            ...
            "whiteBalance": "Auto",
            "exposureBias": 0,
            "maxApertureValue": 0.9708537,
            "lens": "MD 50mm F1.4"
           }
        img_description = "A great day to be outside enjoying the sunshine. Loving this!"
        ...
        try:
            i = 0
            while(i < 5):
                if cv_response['results'][0]['tags'][1]['confidence'] > 25:
